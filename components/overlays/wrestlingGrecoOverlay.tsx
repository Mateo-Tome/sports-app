// components/overlays/WrestlingGrecoOverlay.tsx
...
export default function WrestlingGrecoOverlay({
  isRecording,
  onEvent,
  ...
  const PassPenaltyChooser = () => {
    ...
    const { actor: offenderActor, color: offenderColor, title: offenderTitle } = sideInfo(ppFor);
    const receiver = receiverOf(offenderActor as any);

    return (
      <View pointerEvents="box-none" style={{ position: 'absolute', top: CHOOSER_TOP, left: EDGE_L, right: EDGE_R, alignItems: 'center', zIndex: 50 }}>
        <View style={{ maxWidth: screenW - (EDGE_L + EDGE_R), backgroundColor: 'rgba(0,0,0,0.74)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.25)', borderRadius: 16, paddingVertical: 10, paddingHorizontal: 12 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 6 }}>
            <Text style={{ color: 'white', fontWeight: '900', fontSize: 14, marginRight: 8 }}>
  ...
  const PinConfirm = () => {
    ...
    return (
      <View pointerEvents="box-none" style={{ position: 'absolute', top: CHOOSER_TOP, left: EDGE_L, right: EDGE_R, alignItems: 'center', zIndex: 60 }}>
        <View style={{ maxWidth: screenW - (EDGE_L + EDGE_R), backgroundColor: 'rgba(0,0,0,0.78)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.28)', borderRadius: 16, paddingVertical: 12, paddingHorizontal: 14 }}>
          <Text style={{ color: 'white', fontWeight: '900', textAlign: 'center', marginBottom: 10 }}>
            Confirm PIN for {title}?
          </Text>

          <View style={{ flexDirection: 'row', justifyContent: 'center', gap: 10 }}>
            <TouchableOpacity onPress={() => setPinFor(null)} style={{ paddingVertical: 9, paddingHorizontal: 14, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.12)' }}>
            ...
            <TouchableOpacity onPress={() => {
              ...
              setPinFor(null);
            }} style={{ paddingVertical: 9, paddingHorizontal: 14, borderRadius: 999, backgroundColor: color }}>
  ...
  return (
    <View pointerEvents="box-none" style={{ position: 'absolute', left: 0, right: 0, top: TOP, bottom: BOTTOM }}>
      ...
      <View style={{ position: 'absolute', top: -36, right: EDGE_R, alignItems: 'flex-end' }} pointerEvents="box-none">
        <TouchableOpacity
